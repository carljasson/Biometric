...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4><i class="bi bi-people-fill me-2"></i> Registered Users</h4>
    <button class="btn btn-primary" id="printUsersBtn"><i class="bi bi-printer me-1"></i> Print Users</button>
</div>
...
<!-- Users Cards -->
<div class="grid gap-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4" id="usersGrid">
    @foreach($users as $user)
    <div class="rounded shadow-md overflow-hidden transition hover:shadow-lg p-2">
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Print functionality
    document.getElementById('printUsersBtn').addEventListener('click', function () {
        const printContents = document.getElementById('usersGrid').innerHTML;
