...
class AdminBackupController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.backups')->with('success', 'Backup uploaded: ' . $filename);
    }
    ...
    public function download($filename)
    {
        ...
        if (!Storage::exists($path)) {
            return redirect()->route('admin.backups')->withErrors('File not found.');
        }
    ...
    public function destroy($filename)
    {
        ...
        return redirect()->route('admin.backups')->with('success', 'Deleted: ' . $filename);
    }
}
